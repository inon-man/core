...
# fund the validator
terrad tx bank send test0 $(terrad keys show validator -a --keyring-backend $KEYRING_BACKEND --home $NODE_HOME) 50000000uluna --chain-id $CHAIN_ID --keyring-backend $KEYRING_BACKEND --home $NODE_HOME --gas auto --gas-adjustment 2.3 --fees 20000000uluna -y
